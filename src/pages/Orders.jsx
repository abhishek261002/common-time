...
export default function Orders() {
  ...
  return (
    <main className="min-h-screen py-16 px-4 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-8 uppercase">Orders</h1>
      {loading ? (
          ...
          {orders.map((order) => (
            ...
            >
              <button
                ...
                className="w-full px-4 py-4 flex flex-wrap items-center justify-between gap-2 text-left hover:bg-gray-50"
              >
                <div>
                  ...
                  {order.items.map((oi) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-medium">{oi.product?.name}</p>
